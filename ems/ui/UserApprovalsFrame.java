...
public class UserApprovalsFrame extends JFrame {
    ...
    public UserApprovalsFrame() {
        setTitle("EMS - Pending User Approvals");
    ...
    private void updateSelected(AccountStatus status) {
        ...
        if (row < 0) {
            Ui.error(this, "Select a user first");
            return;
        }
        ...
        try {
            ...
            try {
                ...
                // Don't block approval workflow if email fails
